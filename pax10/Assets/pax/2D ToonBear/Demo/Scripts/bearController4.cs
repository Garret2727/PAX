...
public class bearController4 : MonoBehaviour {
...
//		startTime = Time.time;
	...
	void Update()
	{
		...
		if (Input.GetButtonDown("AttackA") && (grounded)) { anim.SetTrigger("Punch"); }

		if (Input.GetButtonDown("AttackB") && (grounded)) { anim.SetTrigger("Punch"); }

		if (Input.GetButtonDown("AttackC") && (grounded)) { anim.SetTrigger("Punch"); }

		if (Input.GetButtonDown("AttackD") && (grounded)) { anim.SetTrigger("Punch"); }
